<template>
  <div class="home">
    ...
    <van-tabs v-model="active" type="card" sticky offset-top="45" title-active-color="#fff" @click="onClickNav">
      <van-tab title-style="padding-top:8px;box-sizing: border-box;" v-for="item in navTab" :key="item.index"
        :title="item.nav" :badge="item.totalCount">
