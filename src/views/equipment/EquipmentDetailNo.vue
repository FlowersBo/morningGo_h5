    ...
    <div class="alarm">
      ...
      <div class="alarm-right">
        ...
        <van-icon class="iconfont icon" v-if="device.isbad == 1" color="#FF0000" class-prefix="icon"
          name="weixiujibie-" />
        <van-icon class="iconfont icon" v-if="device.stopSell == 0" color="#00CC00" class-prefix="icon"
          name="tongzhi" />
        <van-icon class="iconfont icon" v-if="device.stopSell == 1" color="#FF0000" class-prefix="icon"
          name="tongzhi" />
      </div>
    </div>
    <div class="btnWrap">
