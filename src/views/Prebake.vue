      ...
      >
        <van-cell v-for="item in repertoryList" :key="item.deviceid">
          <div
            class="alarm"
            @click="
              gotoSetRepertory(item.factoryno, item.pointname, item.deviceno)
            "
          >
            <div class="alarm-content">
              ...
              <div class="content-item">
                <div class="itemKey">
                  当前库存：A：{{ item.aStore }} B：{{ item.bStore }}
                </div>
              </div>
              <div class="content-item">
                <div class="itemKey">
                  ...
                  <div>
                    ...
                    <span
                      >B区：烤制中{{ item.bing }} 已完成{{ item.bing }}</span
                    >
                  </div>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    gotoSetRepertory(factoryno, pointname, deviceno) {
      //跳转设置
      this.$router.push({
        path: '/SetPrebake',
        query: {
